...
export default function CreateResearchAreaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.category.trim().length < 2) {
      showError('Category must be at least 2 characters long');
      return;
    }
    
    if (formData.category.trim().length > 100) {
      showError('Category must be less than 100 characters');
      return;
    }
    ...
    try {
      ...
      console.log('Creating research area with data:', requestData);
      ...
      if (response.ok) {
        console.log('Research area created successfully:', responseData);
        console.log('Created research area studentIds:', responseData.data?.item?.studentIds);
        showSuccess('Research area created successfully!');
        router.push('/research-areas');
      } else {
        console.error('Failed to create research area:', responseData);
        let errorMessage = 'Failed to create research area';
        ...
        if (responseData.message) {
          ...
          errorMessage = 'You do not have permission to create research areas.';
        }
      ...
      showError('Network error while creating research area');
    } finally {
  ...
  return (
    <AdminLayout pageTitle="Create Research Area">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-black">Create New Research Area</h1>
            <p className="text-black">Add a new research area and focus area</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
              ...
              <button
                ...
                disabled={isSubmitting}
              >
                {isSubmitting ? 'Creating...' : 'Create Research Area'}
              </button>
            </div>
          </form>
        </div>
