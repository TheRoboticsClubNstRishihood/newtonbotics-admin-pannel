...
export async function PUT(
  ...
  try {
    ...
    const notificationIndex = mockNotifications.findIndex(notif => notif._id === id);
      ...
      return NextResponse.json(
        { 
          ...
          error: { 
            ...
            details: { statusCode: 404, isOperational: true }
          },
          timestamp: new Date().toISOString(),
          path: '/api/admin/dashboard/notifications/[id]/read',
          method: 'PUT'
        },
        { status: 404 }
      );
